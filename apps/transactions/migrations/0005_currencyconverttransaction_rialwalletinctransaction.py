# Generated by Django 2.0 on 2018-08-25 05:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('transactions', '0004_auto_20180824_1903'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_inc', models.FloatField(validators=[django.core.validators.MaxValueValidator(1000), django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid', models.BooleanField(default=False)),
                ('verified', models.BooleanField(default=False)),
                ('rial_inc', models.FloatField(default=0, validators=[django.core.validators.MaxValueValidator(300000000), django.core.validators.MinValueValidator(100000)])),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.Customer')),
            ],
            options={
                'abstract': False,
